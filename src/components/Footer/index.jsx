      ...
      <div className={classes.root + " pb-5 pb-md-0"}>
        <div className="container">
          ...
          <div className="row" style={{ paddingTop: "8rem" }}>
            ...
            <div className="col-md-3 mt-5 mt-sm-0 col-7">
              <Typography className={classes.title} variant="h6">
                {" "}
            ...
            <div className="col-md-3 mt-5 mt-sm-0 col-5">
              <Typography className={classes.title} variant="h6">
                {" "}
                <FormattedMessage id="footer.title4" />{" "}
              </Typography>
              <a
              ...
              <a
                ...
                className={classes.link}
                target="_blank"
                href="https://medium.com/ki-foundation"
              >
                Medium
              </a>
              <a
                ...
                className={classes.link}
                target="_blank"
                href="https://www.linkedin.com/company/kifoundation/"
              >
                Linkedin
              </a>
            </div>
