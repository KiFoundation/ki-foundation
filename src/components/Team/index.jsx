  ...
  renderTopBar = () => (
    <div className="row" style={{ paddingTop: '1rem' }}>
      <div className="col d-flex justify-content-between align-items-center">
        <div>
          <Link id="nav-link-logo" to={`/${this.props.locale}`}><LazyImage height="12" src={KiFoundationLogo} alt="Ki Foundation" /></Link>
        </div>
    ...
    return (
      <section id="team">
        ...
        <div className="team-row row">
          ...
          <div className="team-member col-xs-4 col-sm-4 col-md-3 col-lg-3">
            <LazyLoad className="d-contents" offsetVertical={1100} height={166}><img src={martin} alt="" /></LazyLoad>
            <a id="home-team-linkedin-rosenbaum" href="https://fr.linkedin.com/in/martin-rosenbaum-485a1487" target="_blank" rel="noopener noreferrer" className="second">
              <LazyLoad className="d-contents" offsetVertical={1100} height={32}><img src={linkedin} alt="linkedin" /></LazyLoad>
            </a>
            <span className="team-name">Martin Rosenbaum</span>
            <span className="team-job">Chief Customers & Investors relations</span>
          </div>

          <div className="team-member col-xs-4 col-sm-4 col-md-3 col-lg-3">
            <LazyLoad className="d-contents" offsetVertical={1100} height={166}><img src={michael} alt="" /></LazyLoad>
            <a id="home-team-linkedin-julienguy" href="https://uk.linkedin.com/in/michael-levy-94017a34" target="_blank" rel="noopener noreferrer" className="second">
              <LazyLoad className="d-contents" offsetVertical={1100} height={32}><img src={linkedin} alt="linkedin" /></LazyLoad>
            </a>
          ...
          <div className="team-member col-xs-4 col-sm-4 col-md-3 col-lg-3">
            ...
            <a id="home-team-linkedin-popo" href="https://www.linkedin.com/in/arnaud-polette-0b302340/" target="_blank" rel="noopener noreferrer" className="second">
              <LazyLoad className="d-contents" offsetVertical={1100} height={32}><img src={linkedin} alt="linkedin" /></LazyLoad>
            </a>
            <a id="home-team-twitter-popo" href="https://twitter.com/arnaudpolette" target="_blank" rel="noopener noreferrer" className="first">
          ...
          <div className="team-member col-xs-4 col-sm-4 col-md-3 col-lg-3">
            <LazyLoad className="d-contents" offsetVertical={1100} height={166}><img src={coco} alt="" /></LazyLoad>
            <a id="home-team-linkedin-foure" href="https://fr.linkedin.com/in/corentin-foure/" target="_blank" rel="noopener noreferrer" className="second">
              <LazyLoad className="d-contents" offsetVertical={1100} height={32}><img src={linkedin} alt="linkedin" /></LazyLoad>
            </a>
          ...
          <div className="team-member col-xs-4 col-sm-4 col-md-3 col-lg-3">
            <LazyLoad className="d-contents" offsetVertical={1100} height={166}><img src={hubertus} alt="" /></LazyLoad>
            <a id="home-team-twitter-vonheyden" href="https://twitter.com/immasssi?ref_src=twsrc%5Egoogle%7Ctwcamp%5Eserp%7Ctwgr%5Eauthor" target="_blank" rel="noopener noreferrer" className="first">
              <LazyLoad className="d-contents" offsetVertical={1100} height={32}><img src={twitter} alt="twitter" /></LazyLoad>
            </a>
          ...
          <div className="team-member col-xs-4 col-sm-4 col-md-3 col-lg-3">
            <LazyLoad className="d-contents" offsetVertical={1100} height={166}><img src={manouuu} alt="" /></LazyLoad>
            <a id="home-team-linkedin-manconi" href="https://it.linkedin.com/in/emanuele-manconi-142a81107" target="_blank" rel="noopener noreferrer" className="second">
              <LazyLoad className="d-contents" offsetVertical={1100} height={32}><img src={linkedin} alt="linkedin" /></LazyLoad>
            </a>
          ...
          <div className="team-member col-xs-4 col-sm-4 col-md-3 col-lg-3">
            <LazyLoad className="d-contents" offsetVertical={1100} height={166}><img src={allan } alt="" /></LazyLoad>
            <a id="home-team-linkedin-floury" href="https://fr.linkedin.com/in/allanfloury" target="_blank" rel="noopener noreferrer" className="second">
              <LazyLoad className="d-contents" offsetVertical={1100} height={32}><img src={linkedin} alt="linkedin" /></LazyLoad>
            </a>
