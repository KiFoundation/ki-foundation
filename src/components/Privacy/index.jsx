          ...
          <div className="row">
            <div className="col-12">
              <Typography
                ...
                gutterBottom
                className={
                  classes.headerTitle + " primary-gradient mb-2 proxima-bold"
                }
              >
                Privacy Policy
              </Typography>
            ...
            <div className="col-12">
              ...
              <div className="ml-5">
                <span>
                  <span className="mb-3">
                    Welcome to Ki Foundation’s privacy policy.
                  </span>
                  <span className="mb-3">
                    Ki Foundation respects your privacy and is committed to
            ...
            <div className="col-12">
              ...
              <div className="ml-5">
                ...
                <span>
                  This privacy policy aims to give you information on how Ki
                  Foundation collects and processes your personal data through
                  your use of this website, including any data you may provide
                  through this website when you participate in our token sale.
                  ...
                  specific occasions when we are collecting or processing
                  personal data about you so that you are fully aware of how and
                  why we are using your data. This privacy policy supplements
                  other notices and privacy policies and is not intended to
                  override them.
                </span>
                <br />
                <span className="privacy-subtitle">CONTROLLER</span>
                <span>
                  Ki Foundation is the controller and responsible for your
                  personal data (collectively referred to as ” Ki Foundation”,
                  “we”, “us” or “our” in this privacy policy). We have appointed
                  a data privacy manager who is responsible for overseeing
                  questions in relation to this privacy policy. If you have any
                  questions about this privacy policy please contact the data
                ...
                <span>
                  ...
                  the following ways: Full name of legal entity: Ki Foundation
                  Email address: support@ki.foundation You have the right to
                  make a complaint at any time to your local supervisory
                  authority for data protection issues. We would, however,
                  appreciate the chance to deal with your concerns before you
                  approach the authority so please contact us in the first
                  instance.
                </span>
                <br />
                <span className="privacy-subtitle">
                ...
                <span>
                  ...
                  important that the personal data we hold about you is accurate
                  and current. Please keep us informed if your personal data
                  changes during your relationship with us.
                </span>
                <br />
                <span id="privacy-2" className="privacy-subtitle">
                  THIRD-PARTY LINKS
                </span>
                <span>
            ...
            <div className="col-12">
              ...
              <div className="ml-5">
                <span>
                  ...
                  different kinds of personal data about you which we have
                  grouped together as follows:
                </span>
                <br />
                <ul>
                  <li>
                    <b>Identity Data includes</b> [first name, maiden name, last
                    name, username or similar identifier, marital status, title,
                    date of birth and gender].
                  </li>
                  <li>
                    <b>Contact Data includes</b> [billing address, delivery
                    address, email address and telephone numbers].
                  </li>
                  <li>
                    <b>Financial Data includes</b> [bank account and payment
                    card details].
                  </li>
                  <li>
                    <b>Transaction Data includes</b> [details about payments to
                    and from you and other details of products and services you
                    have purchased from us].
                  </li>
                  <li>
                    <b>Technical Data includes</b> [internet protocol (IP)
                  ...
                  <li>
                    <b>Profile Data includes</b> [your username and password,
                    purchases or orders made by you, your interests,
                    preferences, feedback and survey responses].
                  </li>
                  <li>
                    <b>Usage Data includes</b> [information about how you use
                    our website, products and services].
                  </li>
                  <li>
                    <b>Marketing and Communications Data includes</b> [your
                ...
                <br />
                <span id="privacy-3" className="privacy-subtitle">
              ...
              <div className="ml-5">
                ...
                <ul className="mb-0">
                  <li>
                    ...
                    personal data you provide when you [DELETE OR ADD TO THIS
                    LIST AS APPROPRIATE]:
                  </li>
                  ...
                  <li>
                    ...
                    [and public sources] as set out below [DELETE OR ADD TO THIS
                    LIST AS APPROPRIATE]:
                  </li>
                  ...
                  <li>
                    (b) advertising networks [such as [NAME] based [inside OR
                    outside] the EU]; and
                  </li>
                  <li>
                    (c) search information providers [such as [NAME] based
                    [inside OR outside] the EU].
                  </li>
                  <br id="privacy-4" />
                  <li>
                    Contact, Financial and Transaction Data from providers of
                    technical, payment and delivery services [such as [NAME]
                    based [inside OR outside] the EU].
                  </li>
                  <li>
                    Identity and Contact Data from data brokers or aggregators
                    [such as [NAME] based [inside OR outside] the EU].
                  </li>
                  <li>
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>
                        ...
                        <div className="d-block">(b) Contact</div>
                        <span className="mb-2"></span>
                        <div className="d-block">(c) Financial</div>
                        <span className="mb-2"></span>
                        <div className="d-block">(d) Transaction</div>
                        <span className="mb-2"></span>
                        <div className="d-block">
                    ...
                    <tr>
                      ...
                      <td>
                        ...
                        <div className="d-block">(b) Contact</div>
                        <span className="mb-2"></span>
                        <div className="d-block">(c) Profile</div>
                        <span className="mb-2"></span>
                        <div className="d-block">
                          (e) Marketing and Communications
                        </div>
                    ...
                    <tr>
                      ...
                      <td>
                        ...
                        <div className="d-block">(c) Profile</div>
                        <span className="mb-2"></span>
                        <div className="d-block">(d) Usage</div>
                        <span className="mb-2"></span>
                        <div className="d-block">
                          (e) Marketing and Communications
                        </div>
                    ...
                    <tr>
                      ...
                      <td>
                        ...
                        <div className="d-block">(b) Contact</div>
                        <span className="mb-2"></span>
                        <div className="d-block">(c) Technical</div>
                      </td>
                      <td>
                        <div className="d-block">
                    ...
                    <tr>
                      ...
                      <td>
                        ...
                        <span className="mb-2"></span>
                        <div className="d-block">(f) Technical</div>
                      </td>
                      <td>
                        <div className="d-block">
                    ...
                    <tr>
                      ...
                      <td>
                        <div className="d-block">(a) Identity</div>
                        <span className="mb-2"></span>
                        <div className="d-block">(b) Usage</div>
                      </td>
                      <td>
                        <div className="d-block">
                    ...
                    <tr>
                      ...
                      <td>
                        ...
                        <div className="d-block">(d) Usage</div>
                        <span className="mb-2"></span>
                        <div className="d-block">(e) Profile</div>
                        <span className="mb-2"></span>
                        <div className="d-block">
              ...
              <div className="ml-5">
                ...
                <ul className="mb-0">
                  ...
                  <li>
                    ...
                    which we will use your personal data] above OR such as
            ...
            <div className="col-12">
              ...
              <div className="ml-5">
                <span>
                  We share your personal data within the Ki Foundation Company.
                ...
                <ul className="mb-0">
                  ...
                  <li id="privacy-7">
                    ...
                    <a href="https://ec.europa.eu/info/strategy/justice-and-fundamental-rights/data-protection/data-transfers-outside-eu/eu-us-privacy-shield_en">
            ...
            <div className="col-12">
              ...
              <div className="ml-5">
                ...
                <span>
                  <b>Legitimate Interest</b> means the interest of our business
                ...
                <span>
                  Other companies in the Ki Foundation Company which provide [IT
                  and system administration services and undertake leadership
                  reporting].
                </span>
                <br />
                ...
                <ul className="ml-0">
                  <li>
                    ...
                    COUNTRIES] who provide [IT and system administration
                    services].
                  </li>
                  <li>
                    Professional advisers [acting as processors or joint
                    controllers] including lawyers, bankers, auditors and
                    insurers based in [SPECIFIC COUNTRIES] who provide
                    [consultancy, banking, legal, insurance and accounting
                    services].
                  </li>
                  <li>
                    [DETAILS OF ANY OTHER THIRD PARTIES, FOR EXAMPLE, MARKET
                    RESEARCHERS, FRAUD PREVENTION AGENCIES, PRICE COMPARISON
                    SITES AND SO ON.]
                  </li>
                </ul>
                <br />
                ...
                <br />
                <span>
                  <b>Object to processing of your personal data</b> where we are
