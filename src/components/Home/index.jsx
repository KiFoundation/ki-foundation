    ...
    <div className="row" style={{paddingTop: '1rem'}}>
      <div className="col d-flex justify-content-between align-items-center">
        ...
        <div className="d-none d-sm-block">
          <a id="footer-link-whitepaper" className={this.props.classes.link + ' btn btn-primary btn-mwidth'} rel="noopener noreferrer" href="https://static.foundation.ki/documents/ki-whitepaper.pdf" target="_blank" download>
  ...
  renderBanner = () => (
      <div>
        <div className="row align-items-center mt-5 mt-lg-0">
          <div className="col">
            <h2 style={{lineHeight: '3rem', fontWeight: 700, fontSize: '1.8rem'}}>Creating a <u style={{textDecorationColor: '#043bea'}}>stron</u>g and <u style={{textDecorationColor: '#043bea'}}>fair</u><br />ecosystem of <mark style={{padding: '0 5px', backgroundColor: '#043bea', color: 'white'}}>value</mark></h2>
            ...
            <div className="row" style={{marginTop: '2rem'}}>
              <div className="col">
                ...
                <Button color="primary" variant="outlined" className="fs-11 mx-2 px-4 btn-mwidth first-capitalize" onClick={this.handleOpen}>
