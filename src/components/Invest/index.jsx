        ...
        let renderInvestInput = this.investValues.map(iv => {
            return (
                <div key={iv} className="form-check mb-4 d-flex mx-3">
                    <input onChange={this.handleChange} value={iv} name="invest" type="radio" className="form-check-input" required/>
        ...
        return (
            <div>
                ...
                <div className="col-md-12 mb-4 px-0 mt-4">
                    <Typography variant="h6" className={classes.subtitle} align="center"><FormattedMessage id="amount.invest.title"/></Typography>
                </div>
                ...
                <div className="col-md-12 mb-3 px-0">
                    <Typography variant="h6" className={classes.subtitle} align="center"><FormattedMessage id="getintouch.title"/></Typography>
                </div>
                <div className="vertical-align">
                    <div className="d-flex">
                        <div className="form-check mb-4 d-flex">
                            <input onChange={this.handleChange} value={yesLabel} name="meeting" type="radio" className="form-check-input"/>
                            <label className="form-check-label" htmlFor={yesLabel}>
                                {yesLabel}
                            </label>
                        </div>
                        <div className="form-check mb-4 d-flex ml-4">
                            <input defaultChecked onChange={this.handleChange} value={noLabel} name="meeting" type="radio" className="form-check-input"/>
                            <label className="form-check-label" htmlFor={noLabel}>
                                {noLabel}
                            </label>
                        </div>
                    </div>
                ...
                <div className="container py-5">
                    <div className="row justify-content-center">
                        <div className="col-md-8">
                            <Typography className={classes.title + ' animated fadeInDown primary-gradient proxima-bold'} variant="h3" align="center">
                                <FormattedMessage id="invest.title" />
                            </Typography>
                            <Typography variant="h6" className={classes.subtitle} align="center"><FormattedMessage id="invest.subtitle" /></Typography>
                            { showSuccessMessage &&
